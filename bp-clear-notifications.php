...
class Clear_BP_Notifications_Helper {
	 ...
	 * Singleton Instance
	 *
	 * @var Clear_BP_Notifications_Helper
	 */
	...
	/**
	 * Add notification meneu to BuddyBar
	 */
		...
		if ( $notifications ) {
			...
			for ( $i = 0, $count = count( $notifications ); $i < $count; ++ $i ) {
                ...
                <li<?php echo $alt ?>><?php echo $notifications[ $i ] ?>
                    <!--<span class='close-notification' id='bp-clear-notification-'>x</span> --></  li>
            ...
            <li>
                <a href="<?php echo $bp->loggedin_user->domain ?>"><?php _e( 'No new notifications.', 'buddypress' ); ?></a>
            </li>
	...
	/**
	 * Add clear notification item to WordPress admin bar.
	 */
	...
	/**
	 * Clear notification ajax handler.
	 */
	...
	/**
	 * Mark red all notifications for the user.
	 *
	...
	/**
	 * Check if this plugin is usable.
	 *
	 * @return bool
	 */
